...
<html lang="en">
	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(237, 41, 57)">
			<div class="container">
				...
				<div class="justify-content-center">
					<ul class="nav">
						...
						<li class="nav-item">
							<a href="url('/')" class="nav-link text-white">Tentang Kami</a>
						</li>
						<li class="nav-item">
				...
				@else
				<a href="{{ Route('login') }}" class="btn btn-primary btn-md">Masuk</a>
				@endif
			</div>
		</nav>
		@yield('content')
